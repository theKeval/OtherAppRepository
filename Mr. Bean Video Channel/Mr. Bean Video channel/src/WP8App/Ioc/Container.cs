...
namespace WPAppStudio.Ioc
{
    ...
    public class Container : IIoc.IContainer
    {
        ...
        public Container()
        {
            ...
            _currentContainer.RegisterType<IViewModels.IMicrosoft_VideosViewModel, ViewModels.Microsoft_VideosViewModel>();
            _currentContainer.RegisterType<IViewModels.IMicrosoft_DetailVideosViewModel, ViewModels.Microsoft_DetailVideosViewModel>();
            ...
            {
				_currentContainer.RegisterType<Repositories.IMicrosoft_microsoftvideos, Repositories.Microsoft_microsoftvideos>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IAboutTheseChannels_about, Repositories.AboutTheseChannels_about>(new ContainerControlledLifetimeManager());
			}
			else
			{
				_currentContainer.RegisterType<Repositories.IMicrosoft_microsoftvideos, Repositories.FakeMicrosoft_microsoftvideos>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.IAboutTheseChannels_about, Repositories.FakeAboutTheseChannels_about>(new ContainerControlledLifetimeManager());
