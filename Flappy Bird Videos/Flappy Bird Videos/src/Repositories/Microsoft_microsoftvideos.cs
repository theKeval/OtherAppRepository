...
namespace WPAppStudio.Repositories
{
    ...
    public class Microsoft_microsoftvideos : IMicrosoft_microsoftvideos 
    {
		...
		private const string YoutubeQuery = @"Flappy Bird";
        ...
        /// <summary>
        /// Retrieves the data from Youtube (query: Flappy Bird ), in an observable collection of YouTubeVideo items.
        /// </summary>
        ...
        /// <summary>
        /// Refresh the data from Youtube (query: Flappy Bird ), in an observable collection of YouTubeVideo items.
        /// </summary>
        /// <returns>An observable collection of YouTubeVideo items.</returns>
		...
		/// <summary>
        /// Retrieves the data from Youtube (query: Flappy Bird ), filtered by a filter specification, in an observable collection of YouTubeVideo items.
        /// </summary>
