...
namespace WPAppStudio.ViewModel
{
    ...
    {       
        ...
        {
				_shareService.Share(@"about the game", CurrentAboutTheseChannels_InfoHtmlControl);
        }
        ...
        {
				_lockScreenService.SetLockScreen("LockScreen-8b47142c-0228-4f00-a6a3-5d6ef4228c37.jpg");
        }
