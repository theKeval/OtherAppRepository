...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.IMicrosoft_VideosViewModel), "/View/Microsoft_Videos.xaml" },
            { typeof(IViewModels.IMicrosoft_DetailVideosViewModel), "/View/Microsoft_DetailVideos.xaml" },
